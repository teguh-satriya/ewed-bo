            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                <form class="form-inline mr-auto">
                    ...
                    <div class="search-element">
                        ...
                        <button class="btn" type="submi t"><i class="fas fa-search"></i></button>
                    </div>
                </form>
                <ul class="navbar-nav navbar-right">
                        ...
                        <div class="dropdown-menu dropdown-list dropdown-menu-right">
                            ...
                            <div class="dropdown-list-content dropdown-list-message">
                                ...
                                <div class="dropdown-item-avatar">
                                    <img alt="image" src={Avatar1} class="rounded-circle" />
                    ...
                    <li class="dropdown">
                        <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                            <img alt="image" src={Avatar1} class="rounded-circle mr-1" />
                            <div class="d-sm-none d-lg-inline-block">Hai, Teguh</div>
                        </a>
